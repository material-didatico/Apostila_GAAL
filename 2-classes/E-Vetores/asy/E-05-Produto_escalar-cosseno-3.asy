...
label("$\vec{u}-\vec{v}$", (A+B)/2, SW );

label("\Large$\mathbf{a}$", 0.6*A,   SE, pens[3] );
label("\Large$\mathbf{b}$", 0.5*B,   NW, pens[3] );
label("\Large$\mathbf{c}$", (A+B)/2, NE, pens[3] );
