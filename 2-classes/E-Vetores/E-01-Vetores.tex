...
%------------------------------------------------------------------------------%
\begin{frame}{Etimologia do Termo Vetor}
  O termo latino vector deriva do verbo \textit{vehere},

  \pause
  que quer dizer ``levar'', ``conduzir'' ou ``carregar''
\end{frame}

%------------------------------------------------------------------------------%
\begin{frame}{Vetor}
  Na Matemática e Física os vetores são ``setinhas''
...
\begin{frame}{Características dos vetores}
  ...
  \begin{description}[<+->]
      \item[módulo]  ou norma, seu comprimento
...
%------------------------------------------------------------------------------%
\input{ex/E-01-Vetores-ex-02}
\input{ex/E-01-Vetores-ex-03}
\input{ex/E-01-Vetores-ex-04}
